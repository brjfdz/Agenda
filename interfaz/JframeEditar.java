...
public class JframeEditar extends javax.swing.JFrame {
   ...
   private boolean interruptor=false;
    ...
    public DefaultListModel modelList() throws FileNotFoundException {
        ...
        for(String tel:cont.getTelefono())
         model.addElement(tel);
    
        return model;
    }
private DefaultListModel modelList2(String telefono) throws FileNotFoundException, IOException {
    ...
    private void initComponents() {
        ...
        jButtonSeleccionar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonSeleccionarMouseClicked(evt);
            }
        });
       ...
       try {
        ...
        if(phoneUtil.isValidNumber(number)){
            ...
            if(!jTextFieldNombre.getText().equals(model.get(i))){
                cont=agenda.Modificar(cont.getNombre(),model.get(i),num);
            ...
            if(jTextFieldTelefono.getText().contains("+34")){
                String tle=agenda.quitarPrefijo(tele);
                    tele=tle;
                }
            if(!jTextFieldNombre.getText().equals(model.get(i))){
                cont=agenda.Modificar(cont.getNombre(),model.get(i),tele);
                model.removeAllElements();
                try {
                    jListTelefonos.setModel(modelList());
                    jTextFieldTelefono.setText("");
    ...
    private void jButtonSeleccionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSeleccionarMouseClicked
      interruptor=true;
    }//GEN-LAST:event_jButtonSeleccionarMouseClicked
